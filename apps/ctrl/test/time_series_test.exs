defmodule TimeSeriesTest do
  ...
  test "should store a time series", %{time_series: time_series} do
    ...
    assert TimeSeries.get_series(time_series) == [{1000, %{val: 100}}, {2000, %{val: 20}}]
  end
  ...
  test "series should truncate after 3 hours", %{time_series: time_series} do
    ...
    assert TimeSeries.get_series(time_series) == [{2 * @one_hour + 1, @dummy_val}, {3 * @one_hour, @dummy_val}, {5 * @one_hour, @dummy_val}]
  end
